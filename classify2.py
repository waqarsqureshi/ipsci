...
checkpoint_path_swin = '/home/pms/pms-code/ipsci-script/checkpoints/20221101-155102-swinv2_base_window12to24_192to384_22kft1k-384/last.pth.tar'
checkpoint_path_conv = '/home/pms/ConvNeXt/small-model/model_ckpt_cropSegImg6D_384_300_small/checkpoint-best.pth'
...
def create_load_model(name,checkpoint_path):
    if name=='swinv2_base_window12to24_192to384_22kft1k':
        model = create_model(
            name,
            pretrained=False, 
            num_classes=10
        ...
        model = create_model(
            name, # model architecture #'convnext_small'
            pretrained=False,
            pretrained_cfg=None, 
            num_classes=10, 
            drop_path_rate=0,
...
def main() :
    ...
    parser.add_argument("-checkpoint", "--checkpoint", type=str, help="path to checkpoint file", default=checkpoint_path_conv)
    ...
    parser.add_argument('-model',"--model",type=str,default="convnext_small",help="name of the model")
    ...
    if args.savedir:
        ...
        try:
            ...
            exit()
    if args.model=="convext_small":
        args.checkpoint = checkpoint_path_conv
    elif args.model=="swinv2_base_window12to24_192to384_22kft1k" :
